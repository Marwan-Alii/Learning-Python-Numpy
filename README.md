...
Repository: github.com/Marwan-Alii/Learning-Python-Numpy
...
Work day by day — start with the tutorial .py files, then attempt the tasks/questions
Run scripts in any Python environment with NumPy installed:
bash
Copy
pip install numpy
python "Day1 - NumPy Arrays/1. Lists vs Arrays.py"
Check your understanding with the Task10.txt / question10.txt (or .py) explanation prompts
Complete the Mini Project on Day 7 to consolidate all skills
Prerequisites
Python 3.x
